...
DEFAULT_EVENT_RULES: tuple[EventRule, ...] = (
    ...
    EventRule(
        ...
        negative_phrases=("demand remains strong", "demand accelerated", "robust demand"),
    ),
    EventRule(
        ...
        negative_phrases=("margin expansion", "margins improved"),
    ),
    EventRule(
        ...
        negative_phrases=("missed estimates", "below consensus"),
    ),
    EventRule(
        ...
        negative_phrases=("beat estimates", "above consensus"),
    ),
    EventRule(
        ...
        negative_phrases=("raised guidance", "guidance raise", "reaffirmed guidance"),
    ),
)
